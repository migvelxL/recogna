                ...
                <div class="cardArea">
                    ...
                    <div class="card-body">
                        <form class="form-cad">
                            ...
                            <div class="title">
                                <h3><b>ÁREA DO ADMINISTRADOR</b></h3>
                                <hr>
                            </div>
                            ...
                            @foreach ($results as $results)
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" name="maquina" value="<?php if($results->nome == '') {echo 'Nenhuma máquina em uso';} else{ echo $results->nome; } ?>" disabled>
                                    </div>
                                </div>
