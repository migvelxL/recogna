        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="cardAlterar">
                    ...
                    <div class="card-body">
                        <form enctype="multipart/form-data" class="form-cad">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6"> 
                                    <input type="text" class="form-control" name="nome" value="{{ $maq_mais[0]->nome }}" readonly> 
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6"> 
                                    <input type="text" class="form-control" name="mac_address" value="{{ $maq_mais[0]->mac_address }}" readonly> 
                                </div>
                            </div>
                            ...
                            <label class="col-sm-4 col-form-label text-md-right"><b>Status:</b></label>
                                <div class="col-md-6"> 
                                <input type="text" class="form-control" name="status" value="<?php if($maq_mais[0]->status == 1) {echo 'Ok';} else{ echo 'Manutenção'; } ?>" readonly>
                                </div>
                            </div>
                            ...
                            <label class="col-sm-4 col-form-label text-md-right"><b>Restrita:</b></label>
                                <div class="col-md-6"> 
                                <input type="text" class="form-control" name="restrita" value="<?php if($maq_mais[0]->restrita == 1) {echo 'Sim';} else{ echo 'Não'; } ?>" readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6"> 
                                    <input type="text" class="form-control" name="local" value="{{ $maq_mais[0]->local }}" readonly> 
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6"> 
                                    <input type="text" class="form-control" name="dominio" value="{{ $maq_mais[0]->dominio }}" readonly> 
                                </div>
                            </div>
                        ...
                        <a href="{{ url('/controle_maq') }}">
                                <button class="btn btn-primary" style="left: 50px; position:relative;">
                                        {{ __('Voltar') }}      
                                </button>
                        </a> 
