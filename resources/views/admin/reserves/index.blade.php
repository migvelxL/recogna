            ...
            <div class="bg-white overflow-hidden shadow-sm p-5 justify-items-center sm:rounded-lg">
                <div class="flex items-center justify-center h-full">
                    <div class="col-md-8 flex flex-wrap justify-content-center gap-8">
                        <h1 class="w-full text-3xl font-medium text-center">Reservas</h1>
                        @foreach($reserves as $reserve)
                        <a class="text-center transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-105 bg-blue-100 rounded-md overflow-hidden flex flex-column gap-2 justify-content-center px-4 py-3 w-fit" href="{{ route('admin.reserves.edit', ['id' => $reserve->id]) }}">
